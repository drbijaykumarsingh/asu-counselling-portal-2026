...
.cat-sub{font-size:9px;color:rgba(255,255,255,0.3);font-weight:500;margin-top:2px;letter-spacing:1.5px;}
...
.seat-cell.full .seat-fraction{color:var(--full);}
.seat-cell.available .seat-fraction{color:var(--avail);}
.seat-cell.nearly-full .seat-fraction{color:var(--warn);}
...
.seat-cell.full .seat-label{color:rgba(229,62,62,0.6);}
.seat-cell.available .seat-label{color:rgba(34,197,94,0.6);}
.seat-cell.nearly-full .seat-label{color:rgba(245,158,11,0.6);}
.seat-cell.zero .seat-label{color:rgba(255,255,255,0.1);}
