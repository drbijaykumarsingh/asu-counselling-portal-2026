<?php
// ============================================================
//  admin/finance_view.php  –  Finance Review List
//  Lists students who have been approved by HOD (status = 3)
//  and are awaiting Finance verification.
// ============================================================
...
// Fetch students with status = 3 (HOD Approved)
$stmt = $pdo->prepare("
...
// Get count of pending finance reviews
$countStmt = $pdo->query("SELECT COUNT(*) FROM admitted_students WHERE status = 3");
...
.status-badge{display:inline-block;background:#06d6a0;color:#fff;padding:4px 14px;border-radius:20px;font-size:12px;font-weight:600;}
...
.hod-approved{display:inline-flex;align-items:center;gap:4px;padding:3px 10px;border-radius:12px;font-size:11px;font-weight:600;background:#edfdf5;color:#1a6640;}
.hod-approved::before{content:"✓";font-weight:800;}

.btn-proceed{padding:7px 18px;border-radius:8px;font-size:12.5px;font-weight:600;border:none;cursor:pointer;font-family:'Inter',sans-serif;background:linear-gradient(135deg,#06d6a0,#04b38a);color:#fff;text-decoration:none;display:inline-block;transition:opacity .15s,transform .15s;}
...
<main class="main">
  <div class="page-header">
    <div>
      <div class="page-title">Finance Review</div>
      <div class="page-sub">Students approved by HOD, awaiting finance verification</div>
    </div>
  ...
  <div class="stats-row">
    <div class="stat-card">
      ...
      <div class="stat-lbl">Pending Finance Review</div>
    </div>
  </div>
        ...
        <tbody>
          ...
          <tr class="no-results">
            <td colspan="7">
              ...
              No students currently pending finance review.
            </td>
          </tr>
          ...
          <tr>
            ...
            <td><span class="hod-approved">HOD Approved</span></td>
            <td style="text-align:right">
              <a class="btn-proceed" href="finance_review.php?id=<?= (int)$s['id'] ?>">Proceed →</a>
            </td>
          </tr>
